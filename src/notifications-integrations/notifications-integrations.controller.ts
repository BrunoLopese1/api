...
export class NotificationsIntegrationsController {
  constructor(private readonly notificationsIntegrationsService: NotificationsIntegrationsService) {}

  @Post()
  create(@Body() createNotificationsIntegrationDto: CreateNotificationsIntegrationDto) {
    return this.notificationsIntegrationsService.create(createNotificationsIntegrationDto);
  }
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateNotificationsIntegrationDto: UpdateNotificationsIntegrationDto) {
    return this.notificationsIntegrationsService.update(+id, updateNotificationsIntegrationDto);
  }
