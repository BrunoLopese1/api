...
export class QueueIntegrationsController {
  constructor(private readonly queueIntegrationsService: QueueIntegrationsService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateQueueIntegrationDto: UpdateQueueIntegrationDto) {
