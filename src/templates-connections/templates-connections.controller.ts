...
export class TemplatesConnectionsController {
  constructor(private readonly templatesConnectionsService: TemplatesConnectionsService) {}

  @Post()
  create(@Body() createTemplatesConnectionDto: CreateTemplatesConnectionDto) {
    return this.templatesConnectionsService.create(createTemplatesConnectionDto);
  }
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateTemplatesConnectionDto: UpdateTemplatesConnectionDto) {
    return this.templatesConnectionsService.update(+id, updateTemplatesConnectionDto);
  }
